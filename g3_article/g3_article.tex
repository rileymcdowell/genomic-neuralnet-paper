...
\centering
\input{g3_article/figures/simplenet}
...
Networks often don't train well if they are very deep, but recent methods
show that carefully selected initialization of weights in the network
allow efficient training even with very deep networks \citep{
Historically, very large neural networks have taken many CPU-hours to optimize and 
