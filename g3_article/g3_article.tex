...
\hline
\header Author & Species & Trait & Markers\footnote{Markers with greater than 20\% missing calls were filtered from analysis.} & Samples\footnote{Samples without phenotypic measurements were filtered from analysis.} & Prediction Type \\
\hline
Loudet \textit{et al.}         & Arabidopsis   & Days to flowering under short day length  & 69   & 415  & Phenotypic Measurement\\
Loudet \textit{et al.}         & Arabidopsis   & Dry matter accumulation - low resources   & 69   & 415  & Phenotypic Measurement\\
Resende \textit{et al.}        & Loblolly Pine & Crown width at age 6 yrs                  & 926  & 861  & Phenotypic Measurement\\
Resende \textit{et al.}        & Loblolly Pine & Wood lignin content at age 4 yrs          & 926  & 910  & Phenotypic Measurement\\
Crossa \textit{et al.}         & Maize         & Grain yield in well-watered environment   & 1135 & 264  & Phenotypic Measurement\\
Crossa \textit{et al.}         & Maize         & Female flowering date                     & 1148 & 284  & Phenotypic Measurement\\
Cleveland \textit{et al.}      & Pig           & Trait 1 (low heritabilty)                 & 3534 & 2804 & Phenotypic Measurement (corrected for environment)\\
Cleveland \textit{et al.}      & Pig           & Trait 5 (high heritability)               & 3534 & 3184 & Phenotypic Measurement (corrected for environment)\\
Thavamanikumar \textit{et al.} & Wheat         & Time to young microspore (flowering time) & 808  & 324  & TODO XXX \\
Thavamanikumar \textit{et al.} & Wheat         & Spike Grain Number                        & 808  & 324  & TODO XXX \\
\hline
\end{tabularx}
