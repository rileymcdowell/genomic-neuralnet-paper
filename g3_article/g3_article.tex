...
in a process known as overfitting. In order to capture true trends in the data 
rather than noise, a process called regularization is employed. One method
...
epoch, preventing them from co-adapting and overfitting the training set \citep{srivastava2014}.
