...
phenotypes with large effects \citep{miles2008}. Once a sufficient
proportion of critical QTL markers have been identified, they can be leveraged for making selections
...
QTL mapping is less effective \citep{heffner2009}.
...
associations in a data driven way \citep{meuwissen2001}. This technique has
...
genomic selection is dependent on the genetic architecture of the 
...
The weights and biases are typically initialized by drawing from a
...
correlational relationships between two or more input features drove a need to 
