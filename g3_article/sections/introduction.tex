...
to genomic prediction. In addition we explore two types of network regularization
...
performance of regularized networks with some other available genomic prediction models.
